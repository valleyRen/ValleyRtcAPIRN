...
- If you're on a physical device connected to the same machine, run 'adb reverse tcp:19999 tcp:19999' to forward requests from your device
- If your device is on the same Wi-Fi network, set 'Debug server host & port for device' in 'Dev settings' to your machine's IP address and the port of the local dev server - e.g. 10.0.1.1:19999`;
      }
