...
RCT_EXPORT_METHOD(InitSDK) {
    ...
    [[RNValleyRtcApiInternal GetInstance] InitSDK:documentsDirectory localconfig:@"" rtcApi:self];
}

RCT_EXPORT_METHOD(SetAuthoKey:(nonnull NSString*)authokey) {
    NSLog(@"=======  SetAuthoKey, authokey = %@", authokey);
...
RCT_EXPORT_METHOD(GetErrDesc:(NSInteger)ec callback:(RCTResponseSenderBlock)callback) {
    NSLog(@"=======  GetErrDesc, ec = %ld", (long)ec);
...
RCT_EXPORT_METHOD(CreateChannel:(BOOL)withVideo resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    NSLog(@"=======  CreateChannel, withVideo = %d", withVideo);
#if TARGET_OS_SIMULATOR
...
RCT_EXPORT_METHOD(ChannelRelease:(NSInteger)index) {
    NSLog(@"=======  ChannelRelease, index = %ld", (long)index);
#if !TARGET_OS_SIMULATOR
...
RCT_EXPORT_METHOD(ChannelLogout:(NSInteger)index) {
    NSLog(@"=======  ChannelLogout, index = %ld", (long)index);
#if !TARGET_OS_SIMULATOR
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
    if (rtcChannel) {
        [rtcChannel Logout];
...
RCT_EXPORT_METHOD(ChannelGetLoginStatus:(NSInteger)index callback:(RCTResponseSenderBlock)callback) {
    NSLog(@"=======  ChannelGetLoginStatus, index = %ld", (long)index);
#if TARGET_OS_SIMULATOR
    callback(@[@0]);
#else
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
...
RCT_EXPORT_METHOD(ChannelEnableInterface:(NSInteger)index iids:(NSInteger)iids callback:(RCTResponseSenderBlock)callback) {
    NSLog(@"=======  ChannelEnableInterface, iids = %ld, index = %ld", (long)iids, (long)index);
#if TARGET_OS_SIMULATOR
    callback(@[@0]);
#else
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
...
RCT_EXPORT_METHOD(ChannelLogin:(NSInteger)index channelid:(nonnull NSString*)channelid userid:(nonnull NSString*)userid callback:(RCTResponseSenderBlock)callback) {
    NSLog(@"=======  ChannelLogin, channelid = %@, userid = %@, index = %ld", channelid, userid, (long)index);
#if TARGET_OS_SIMULATOR
    callback(@[@0]);
#else
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
...
RCT_EXPORT_METHOD(ChannelSendMsgr:(NSInteger)index msgtype:(int)msgtype msg:(nonnull NSString*)msg  token:(nullable NSString*)token toUID:(nullable NSString*)toUID callback:(RCTResponseSenderBlock)callback) {
    NSLog(@"=======  ChannelSendMsgr, msgtype = %d, msg = %@, token = %@, toUID = %@, index = %ld", msgtype, msg, token, toUID, (long)index);
#if TARGET_OS_SIMULATOR
    callback(@[@0]);
#else
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
...
RCT_EXPORT_METHOD(ChannelSetVideoProfileint:(NSInteger)index profile:(int)profile callback:(RCTResponseSenderBlock)callback) {
    NSLog(@"=======  ChannelSetVideoProfileint, profile = %d, index = %ld", profile, (long)index);
#if TARGET_OS_SIMULATOR
    callback(@[@0]);
#else
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
...
-(void)ChannelSetLocalVideo:(NSInteger)index hVideo:(nonnull xVideoCanvas*)hVideo {
    NSLog(@"=======  ChannelSetLocalVideo, hVideo = %p, index = %ld", hVideo, (long)index);
#if !TARGET_OS_SIMULATOR
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
    int ec = ERR_NOT_INITIALIZE;
    if (rtcChannel) {
    ...
    NSLog(@"=======  ChannelSetLocalVideo, return ec = %d", ec);
#endif
}
...
//    NSLog(@"=======  ChannelRemoveLocalVideo, index = %ld", (long)index);
//#if TARGET_OS_SIMULATOR
//    callback(@[@0]);
//#else
//    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
...
-(void)ChannelRemoveLocalVideo:(NSInteger)index {
    NSLog(@"=======  ChannelRemoveLocalVideo, index = %ld", (long)index);
#if !TARGET_OS_SIMULATOR
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
    int ec = ERR_NOT_INITIALIZE;
    ...
    NSLog(@"=======  ChannelRemoveLocalVideo, return ec = %d", ec);
#endif
}
...
//    NSLog(@"=======  ChannelSetUserVideo, userid = %@, hVideo = %p, index = %ld", userid, hVideo, (long)index);
//#if TARGET_OS_SIMULATOR
//    callback(@[@0]);
//#else
//    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
...
-(void)ChannelSetUserVideo:(NSInteger)index userid:(nonnull NSString*)userid hVideo:(nonnull xVideoCanvas*)hVideo {
    NSLog(@"=======  ChannelSetUserVideo, userid = %@, hVideo = %p, index = %ld", userid, hVideo, (long)index);
#if !TARGET_OS_SIMULATOR
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
    int ec = ERR_NOT_INITIALIZE;
    ...
    NSLog(@"=======  ChannelSetUserVideo, return ec = %d", ec);
#endif
}
...
//    NSLog(@"=======  ChannelRemoveUserVideo, userid = %@, index = %ld", userid, (long)index);
//#if TARGET_OS_SIMULATOR
//    callback(@[@0]);
//#else
//    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
...
-(void)ChannelRemoveUserVideo:(NSInteger)index userid:(nonnull NSString*)userid {
    NSLog(@"=======  ChannelRemoveUserVideo, userid = %@, index = %ld", userid, (long)index);
#if !TARGET_OS_SIMULATOR
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
    int ec = ERR_NOT_INITIALIZE;
...
RCT_EXPORT_METHOD(ChannelEnableLocalVideo:(NSInteger)index bEnable:(BOOL)bEnable callback:(RCTResponseSenderBlock)callback) {
    NSLog(@"=======  ChannelEnableLocalVideo, bEnable = %d, index = %ld", bEnable, (long)index);
#if TARGET_OS_SIMULATOR
    callback(@[@0]);
#else
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
...
RCT_EXPORT_METHOD(ChannelEnableRemoteAudio:(NSInteger)index userid:(nonnull NSString*)userid bEnable:(BOOL)b callback:(RCTResponseSenderBlock)callback) {
    NSLog(@"=======  ChannelEnableRemoteAudio, userid = %@, bEnable = %d, index = %ld", userid, b, (long)index);
#if TARGET_OS_SIMULATOR
    callback(@[@0]);
#else
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
...
RCT_EXPORT_METHOD(ChannelEnableRemoteVideo:(NSInteger)index userid:(nonnull NSString*)userid bEnable:(BOOL)b callback:(RCTResponseSenderBlock)callback) {
    NSLog(@"=======  ChannelEnableRemoteVideo, userid = %@, bEnable = %d, index = %ld", userid, b, (long)index);
#if TARGET_OS_SIMULATOR
    callback(@[@0]);
#else
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
...
RCT_EXPORT_METHOD(ChannelDisableAudio:(NSInteger)index bDisabled:(BOOL)bDisabled callback:(RCTResponseSenderBlock)callback) {
    NSLog(@"=======  ChannelDisableAudio, bDisabled = %d, index = %ld", bDisabled, (long)index);
#if TARGET_OS_SIMULATOR
    callback(@[@0]);
#else
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
...
RCT_EXPORT_METHOD(ChannelDisableVideo:(NSInteger)index callback:(RCTResponseSenderBlock)callback) {
    NSLog(@"=======  ChannelDisableVideo, index = %ld", (long)index);
#if TARGET_OS_SIMULATOR
    callback(@[@0]);
#else
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
...
RCT_EXPORT_METHOD(ChannelSwitchCamera:(NSInteger)index callback:(RCTResponseSenderBlock)callback) {
    NSLog(@"=======  ChannelSwitchCamera, index = %ld", (long)index);
#if TARGET_OS_SIMULATOR
    callback(@[@0]);
#else
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
...
// 扬声器和听筒切换 -1 耳机互动， 0 听筒 1 扬声器 建议在-1和0之间切换
RCT_EXPORT_METHOD(ChannelSetSpeakerOn:(NSInteger)index type:(NSInteger)type callback:(RCTResponseSenderBlock)callback) {
    NSLog(@"=======  ChannelSetSpeakerOn, index = %ld, type = %ld", (long)index, (long)type);
#if TARGET_OS_SIMULATOR
    callback(@[@0]);
#else
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
    int ec = ERR_NOT_INITIALIZE;
    if (rtcChannel) {
        ec = [rtcChannel SetSpeakerOn:(int)type];
    }
    callback(@[ @(ec) ]);
#endif
}
...
RCT_EXPORT_METHOD(ChannelSetChannelAttr:(NSInteger)index name:(nonnull NSString*)name value:(nullable NSString*)value callback:(RCTResponseSenderBlock)callback) {
    NSLog(@"=======  ChannelSetChannelAttr, name = %@, value = %@, index = %ld", name, value, (long)index);
#if TARGET_OS_SIMULATOR
    callback(@[@0]);
#else
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
...
RCT_EXPORT_METHOD(ChannelSetUserAttr:(NSInteger)index uid:(nonnull NSString*)uid name:(nonnull NSString*)name value:(nullable NSString*)value callback:(RCTResponseSenderBlock)callback) {
    NSLog(@"=======  ChannelSetUserAttr, uid = %@, name = %@, value = %@, index = %ld", uid, name, value, (long)index);
#if TARGET_OS_SIMULATOR
    callback(@[@0]);
#else
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
...
RCT_EXPORT_METHOD(ChannelGetChannelAttr:(NSInteger)index name:(nonnull NSString*)name callback:(RCTResponseSenderBlock)callback) {
    NSLog(@"=======  ChannelGetChannelAttr, name = %@, index = %ld", name, (long)index);
#if TARGET_OS_SIMULATOR
...
RCT_EXPORT_METHOD(ChannelGetUserAttr:(NSInteger)index uid:(nonnull NSString*)uid name:(nonnull NSString*)name callback:(RCTResponseSenderBlock)callback) {
    NSLog(@"=======  ChannelGetUserAttr, uid = %@, name = %@, index = %ld", uid, name, (long)index);
#if TARGET_OS_SIMULATOR
    callback(@[ [NSNull null] ]);
#else
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
...
#define ERR_GET_USER_NULL  -1
#define ERR_GET_USER_LIST_NULL  -1
...
RCT_EXPORT_METHOD(ChannelGetUser:(NSInteger)index uid:(nonnull NSString*)uid resolve:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    NSLog(@"=======  ChannelGetUser, uid = %@, index = %ld", uid, (long)index);
#if TARGET_OS_SIMULATOR
    reject([NSString stringWithFormat:@"%@",@(ERR_GET_USER_NULL)], @"-5", nil);
#else
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
    if (rtcChannel) {
...
RCT_EXPORT_METHOD(ChannelGetUserList:(NSInteger)index resolve:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    NSLog(@"=======  ChannelGetUserList, index = %ld", (long)index);
#if TARGET_OS_SIMULATOR
    reject([NSString stringWithFormat:@"%@",@(ERR_GET_USER_LIST_NULL)], @"-5", nil);
#else
    IRtcChannel *rtcChannel = [rtcChannelDic objectForKey:@(index)];
    if (rtcChannel) {
...
- (NSDictionary*)constantsToExport {
    ...
    return @{@"ERR_SUCCEED":@(ERR_SUCCEED),
             ...
             @"IID_USERS":@(IID_USERS),
             @"IID_AUDIO":@(IID_AUDIO),
             @"IID_AUDIOSYSTEM":@(IID_AUDIOSYSTEM),
             ...
             @"ERR_GET_USER_NULL":@(ERR_GET_USER_NULL),
             @"ERR_GET_USER_LIST_NULL":@(ERR_GET_USER_LIST_NULL),
             };
}
...
- (NSDictionary*)fromObjRespLogin:(objRespLogin*)in index:(NSNumber*)index {
    NSLog(@"=======  fromObjRespLogin, code = %d, event = %d, index = %@, userid = %@", [in getErrorCode], [in getEventID], index, [in getUserID]);
    return @{
...
- (NSDictionary*)fromObjNtfUserEnter:(objNtfUserEnter*)in index:(NSNumber*)index {
    NSLog(@"=======  fromObjNtfUserEnter, code = %@, event = %d, index = %@, userid = %@", @(ERR_SUCCEED), [in getEventID], index, [in getUserID]);
    return @{
             @"code":@(ERR_SUCCEED),
             @"event":@([in getEventID]),
             @"index":index,
...
- (NSDictionary*)fromObjNtfUserLeave:(objNtfUserLeave*)in index:(NSNumber*)index {
    NSLog(@"=======  fromObjNtfUserLeave, code = %@, event = %d, index = %@, userid = %@", @(ERR_SUCCEED), [in getEventID], index, [in getUserID]);
    return @{
             @"code":@(ERR_SUCCEED),
             @"event":@([in getEventID]),
             @"index":index,
...
- (NSDictionary*)fromObjRespMsg:(objRespMsg*)in index:(NSNumber*)index {
    NSLog(@"=======  fromObjRespMsg, code = %@, event = %d, index = %@, from_userid = %@, to_userid = %@, msg = %@, token = %@, msg_type = %@, msg_time = %@", @([in getErrorCode]), [in getEventID], index, [in getFromUserID], [in getToUserID], [in getMessage], [in getToken], @([in getMsgType]), @([in getMsgTime]));
    return @{
             @"code":@([in getErrorCode]),
             @"event":@([in getEventID]),
             @"index":index,
...
- (NSDictionary*)fromObjNtfMsg:(objNtfMsg*)in index:(NSNumber*)index {
    NSLog(@"=======  fromObjNtfMsg, code = %@, event = %d, index = %@, from_userid = %@, to_userid = %@, msg = %@, token = %@, msg_type = %@, msg_time = %@", @(ERR_SUCCEED), [in getEventID], index, [in getFromUserID], [in getToUserID], [in getMessage], [in getToken], @([in getMsgType]), @([in getMsgTime]));
    return @{
             @"code":@(ERR_SUCCEED),
             @"event":@([in getEventID]),
             @"index":index,
...
- (NSDictionary*)fromObjNtfNetLost:(objNtfNetLost*)in index:(NSNumber*)index {
    NSLog(@"=======  fromObjNtfNetLost, code = %@, event = %d, index = %@", @(ERR_SUCCEED), [in getEventID], index);
    return @{
             @"code":@(ERR_SUCCEED),
             @"event":@([in getEventID]),
             @"index":index,
...
- (NSDictionary*)fromObjNtfNetResume:(objNtfNetResume*)in index:(NSNumber*)index {
    NSLog(@"=======  fromObjNtfNetResume, code = %@, event = %d, index = %@", @(ERR_SUCCEED), [in getEventID], index);
    return @{
             @"code":@(ERR_SUCCEED),
             @"event":@([in getEventID]),
             @"index":index,
...
- (NSDictionary*)fromObjNtfDupLogined:(objNtfDupLogined*)in index:(NSNumber*)index {
    NSLog(@"=======  fromObjNtfDupLogined, code = %@, event = %d, index = %@", @(ERR_SUCCEED), [in getEventID], index);
    return @{
             @"code":@(ERR_SUCCEED),
             @"event":@([in getEventID]),
             @"index":index,
...
- (NSDictionary*)fromObjRespSetChannelAttr:(objRespSetChannelAttr*)in index:(NSNumber*)index {
    NSLog(@"=======  fromObjRespSetChannelAttr, code = %@, event = %d, index = %@, attr_name = %@, attr_value = %@", @([in getErrorCode]), [in getEventID], index, [in attrname], [in attrvalue]);
    return @{
             @"code":@([in getErrorCode]),
             @"event":@([in getEventID]),
             @"index":index,
...
- (NSDictionary*)fromObjNtfSetChannelAttr:(objNtfSetChannelAttr*)in index:(NSNumber*)index {
    NSLog(@"=======  fromObjNtfSetChannelAttr, code = %@, event = %d, index = %@, attr_name = %@, attr_value = %@", @(ERR_SUCCEED), [in getEventID], index, [in attrname], [in attrvalue]);
    return @{
             @"code":@(ERR_SUCCEED),
             @"event":@([in getEventID]),
             @"index":index,
...
- (NSDictionary*)fromObjRespSetUserAttr:(objRespSetUserAttr*)in index:(NSNumber*)index {
    NSLog(@"=======  fromObjRespSetUserAttr, code = %@, event = %d, index = %@, userid = %@, attr_name = %@, attr_value = %@", @([in getErrorCode]), [in getEventID], index, [in userid], [in attrname], [in attrvalue]);
    return @{
             @"code":@([in getErrorCode]),
             @"event":@([in getEventID]),
             @"index":index,
...
- (NSDictionary*)fromObjNtfSetUserAttr:(objNtfSetUserAttr*)in index:(NSNumber*)index {
    NSLog(@"=======  fromObjNtfSetUserAttr, code = %@, event = %d, index = %@, userid = %@, attr_name = %@, attr_value = %@", @(ERR_SUCCEED), [in getEventID], index, [in userid], [in attrname], [in attrvalue]);
    return @{
             @"code":@(ERR_SUCCEED),
             @"event":@([in getEventID]),
             @"index":index,
...
- (NSDictionary*)fromObjUser:(objUser*)in {
    ...
    NSLog(@"=======  fromObjUser, userid = %@", [in userid]);
    return @{
             @"userid":[in userid],
             };
}
...
- (NSDictionary*)fromObjUserList:(objUserList*)in {
    ...
    NSLog(@"=======  fromObjUserList, count = %@, user_id_list = %@", @([in count]), array);
    return @{
             @"count":@([in count]),
             @"user_id_list":array,
             };
