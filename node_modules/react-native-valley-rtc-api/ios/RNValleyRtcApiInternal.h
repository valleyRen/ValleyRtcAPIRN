...
@interface RNValleyRtcApiInternal : NSObject
...
-(void)SetLocalVideo:(NSInteger)index hVideo:(xVideoCanvas*)hVideo;
-(void)RemoveLocalVideo:(NSInteger)index;
-(void)SetUserVideo:(NSInteger)index userid:(nonnull NSString*)userid hVideo:(xVideoCanvas*)hVideo;
