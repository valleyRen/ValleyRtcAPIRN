...
public class RNValleyRtcApiModule extends ReactContextBaseJavaModule {
  ...
  private static Activity valleyActivity = null;
  private Integer g_ChannelIndex = 0;

  private final ReactApplicationContext reactContext;

  private Map<Integer, IRtcChannel> rtcChannelMap = new HashMap<>();

  protected class RtcSinkImpl implements IRtcSink {
    @Override
    public void Notify(int type, Object ob, long userdata) {
      WritableMap params = Arguments.createMap();
      params.putInt("index", (int)(userdata));
  ...
  public RNValleyRtcApiModule(ReactApplicationContext reactContext) {
    ...
    RNValleyRtcApiSingleton.getInstance().SetModule(this);
  }
  ...
  public Map<String, Object> getConstants() {
    ...
    constants.put(RNValleyRtcApiConstants.IID_AUDIOSYSTEM, IRtcChannel.IID_AUDIOSYSTEM);
    ...
    constants.put(RNValleyRtcApiConstants.ERR_GET_USER_NULL, RNValleyRtcApiConstants.INT_ERR_GET_USER_NULL);
    constants.put(RNValleyRtcApiConstants.ERR_GET_USER_LIST_NULL, RNValleyRtcApiConstants.INT_ERR_GET_USER_LIST_NULL);
    return constants;
  }
  ...
  static public void SetActivity(Activity activity) {
    ...
    RNValleyRtcApiModule.valleyActivity = activity;
  }
  ...
  private void channelCallbackToOut(WritableMap params) {
    Log.d(TAG, "===== channelCallbackToOut: params = " + params.toString());
  ...
  public void fromObjRespSetChannelAttr(Object o, WritableMap params) {
    Log.d(TAG, "===== fromObjRespSetChannelAttr");
  ...
  public void fromObjRespSetUserAttr(Object o, WritableMap params) {
    Log.d(TAG, "===== fromObjRespSetUserAttr");
  ...
  public void fromObjNtfSetChannelAttr(Object o, WritableMap params) {
    Log.d(TAG, "===== fromObjNtfSetChannelAttr");
  ...
  public void fromObjNtfSetUserAttr(Object o, WritableMap params) {
    Log.d(TAG, "===== fromObjNtfSetUserAttr");
  ...
  public void GetSDKVersion(Callback callback) {
    String version = ValleyRtcAPI.GetSDKVersion();
    Log.d(TAG, "===== GetSDKVersion: " + version);
  ...
  public void CreateChannel(boolean withVideo, Promise promise) {
    ...
    IRtcChannel rtcChannel = ValleyRtcAPI.CreateChannel(withVideo, RNValleyRtcApiModule.valleyActivity);
    if (rtcChannel != null) {
      rtcChannel.RegisterRtcSink(new RtcSinkImpl(), g_ChannelIndex);
      rtcChannelMap.put(g_ChannelIndex, rtcChannel);
      promise.resolve(g_ChannelIndex);
      g_ChannelIndex++;
    }
    else {
  ...
  @ReactMethod
  public void ChannelRelease(int index) {
    Log.d(TAG, "===== ChannelRelease: index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.remove(index);
    if (rtcChannel != null) {
      rtcChannel.Release();
    }
  }
  ...
  @ReactMethod
  public void ChannelLogout(int index) {
    Log.d(TAG, "===== ChannelLogout: index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    if (rtcChannel != null) {
      rtcChannel.Logout();
    }
  }
  ...
  @ReactMethod
  public void ChannelGetLoginStatus(int index, Callback callback) {
    Log.d(TAG, "===== ChannelGetLoginStatus: index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
  ...
  @ReactMethod
  public void ChannelEnableInterface(int index, int iids, Callback callback) {
    Log.d(TAG, "===== ChannelEnableInterface: iids = " + iids + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
  ...
  @ReactMethod
  public void ChannelLogin(int index, @NonNull String channelid, @NonNull String userid, Callback callback) {
    Log.d(TAG, "===== ChannelLogin: channelid = " + channelid + ", userid = " + userid + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
  ...
  @ReactMethod
  public void ChannelSendMsgr(int index, int msgType, String msg, String token, String toUID, Callback callback) {
    Log.d(TAG, "===== ChannelSendMsgr: msgType = " + msgType + ", msg = " + msg + ", token = " + token + ", toUID = " + toUID + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
  ...
  @ReactMethod
  public void ChannelSetVideoProfileint(int index, int profile, Callback callback) {
    Log.d(TAG, "===== ChannelSetVideoProfileint: profile = " + profile + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
...
//  @ReactMethod
//  public void ChannelSetLocalVideo(int index, hvideo_t hVideo, Callback callback) {
//    Log.d(TAG, "===== ChannelSetLocalVideo: " + ", index = " + index);
//    IRtcChannel rtcChannel = rtcChannelMap.get(index);
//    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
//    if (rtcChannel != null) {
...
//  }
  ...
  public void ChannelSetLocalVideo(int index, hvideo_t hVideo) {
    Log.d(TAG, "===== ChannelSetLocalVideo: " + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
    ...
    Log.d(TAG, "===== ChannelSetLocalVideo: " + ", ec = " + ec);
//    callback.invoke(ec);
  }

//  @ReactMethod
//  public void ChannelRemoveLocalVideo(int index, Callback callback) {
//    Log.d(TAG, "===== ChannelRemoveLocalVideo: " + ", index = " + index);
//    IRtcChannel rtcChannel = rtcChannelMap.get(index);
//    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
//    if (rtcChannel != null) {
...
//  }
  ...
  public void ChannelRemoveLocalVideo(int index) {
    Log.d(TAG, "===== ChannelRemoveLocalVideo: " + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
    ...
    Log.d(TAG, "===== ChannelRemoveLocalVideo: " + ", ec = " + ec);
  }

//  @ReactMethod
//  public void ChannelSetUserVideo(int index, String userid, hvideo_t hVideo, Callback callback) {
//    Log.d(TAG, "===== ChannelSetUserVideo: userid = " + userid + ", index = " + index);
//    IRtcChannel rtcChannel = rtcChannelMap.get(index);
//    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
//    if (rtcChannel != null) {
...
//
//  @ReactMethod
//  public void ChannelRemoveUserVideo(int index, String userid, Callback callback) {
//    Log.d(TAG, "===== ChannelRemoveUserVideo: userid = " + userid + ", index = " + index);
//    IRtcChannel rtcChannel = rtcChannelMap.get(index);
//    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
//    if (rtcChannel != null) {
...
//  }
  ...
  public void ChannelSetUserVideo(int index, String userid, hvideo_t hVideo) {
    Log.d(TAG, "===== ChannelSetUserVideo: userid = " + userid + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
    ...
    Log.d(TAG, "===== ChannelSetUserVideo: " + ", ec = " + ec);
  }

  public void ChannelRemoveUserVideo(int index, String userid) {
    Log.d(TAG, "===== ChannelRemoveUserVideo: userid = " + userid + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
    ...
    Log.d(TAG, "===== ChannelRemoveUserVideo: " + ", ec = " + ec);
  }

  @ReactMethod
  public void ChannelEnableLocalAudio(int index, boolean bEnable, Callback callback) {
    Log.d(TAG, "===== ChannelEnableLocalAudio: bEnable = " + bEnable + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
  ...
  @ReactMethod
  public void ChannelEnableLocalVideo(int index, boolean bEnable, Callback callback) {
    Log.d(TAG, "===== ChannelEnableLocalVideo: bEnable = " + bEnable + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
  ...
  @ReactMethod
  public void ChannelEnableRemoteAudio(int index, String userid, boolean bEnable, Callback callback) {
    Log.d(TAG, "===== ChannelEnableRemoteAudio: bEnable = " + bEnable + ", userid = " + userid + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
  ...
  @ReactMethod
  public void ChannelEnableRemoteVideo(int index, String userid, boolean bEnable, Callback callback) {
    Log.d(TAG, "===== ChannelEnableRemoteVideo: bEnable = " + bEnable + ", userid = " + userid + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
  ...
  @ReactMethod
  public void ChannelDisableAudio(int index, boolean disabled, Callback callback) {
    Log.d(TAG, "===== ChannelDisableAudio: disabled" + disabled + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
      ec = rtcChannel.DisableAudio(disabled);
    }
    callback.invoke(ec);
  }

  @ReactMethod
  public void ChannelDisableVideo(int index, Callback callback) {
    Log.d(TAG, "===== ChannelDisableVideo: " + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
  ...
  @ReactMethod
  public void ChannelSwitchCamera(int index, Callback callback) {
    Log.d(TAG, "===== ChannelSwitchCamera: " + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
      ec = rtcChannel.SetCameraIndex();
    }
    callback.invoke(ec);
  }

  @ReactMethod
  public void ChannelSetSpeakerOn(int index, int type, Callback callback) {
    Log.d(TAG, "===== ChannelSetSpeakerOn: " + ", index = " + index + ", type = " + type);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
      ec = rtcChannel.SetSpeakerOn(type);
    }
    callback.invoke(ec);
  }

  @ReactMethod
  public void ChannelSetChannelAttr(int index, String name, String value, Callback callback) {
    Log.d(TAG, "===== ChannelSetChannelAttr: name = " + name + ", value = " + value + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
  ...
  @ReactMethod
  public void ChannelSetUserAttr(int index, String userid, String name, String value, Callback callback) {
    Log.d(TAG, "===== ChannelSetUserAttr: name = " + name + ", value = " + value + ", userid = " + userid + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    int ec = IRtcChannel.ERR_NOT_INITIALIZE;
    if (rtcChannel != null) {
  ...
  @ReactMethod
  public void ChannelGetChannelAttr(int index, String name, Callback callback) {
    Log.d(TAG, "===== ChannelGetChannelAttr: name = " + name + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    String es = "";
    if (rtcChannel != null) {
      es = rtcChannel.GetChannelAttr(name);
    }
    callback.invoke(es);
  }

  @ReactMethod
  public void ChannelGetUserAttr(int index, String userid, String name, Callback callback) {
    Log.d(TAG, "===== ChannelGetUserAttr: name = " + name + ", userid = " + userid + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    String es = "";
    if (rtcChannel != null) {
      es = rtcChannel.GetUserAttr(userid, name);
    }
    callback.invoke(es);
  }

  @ReactMethod
  public void ChannelGetUser(int index, String userid, Promise promise) {
    Log.d(TAG, "===== ChannelGetUser: userid = " + userid + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    if (rtcChannel != null) {
      objUser u = rtcChannel.GetUser(userid);
      if (u == null) {
        promise.reject(String.valueOf(RNValleyRtcApiConstants.INT_ERR_GET_USER_NULL), "-5");
      }
      else {
        WritableMap params = Arguments.createMap();
        params.putString("userid", u.getUserid());
  ...
  @ReactMethod
  public void ChannelGetUserList(int index, Promise promise) {
    Log.d(TAG, "===== ChannelGetUserList: " + ", index = " + index);
    IRtcChannel rtcChannel = rtcChannelMap.get(index);
    if (rtcChannel != null) {
      objUserList u = rtcChannel.GetUserList();
      if (u == null) {
        Log.d(TAG, "===== ChannelGetUserList: NULL");
        promise.reject(String.valueOf(RNValleyRtcApiConstants.INT_ERR_GET_USER_LIST_NULL), "-5");
      }
      else {
        WritableMap params = Arguments.createMap();
        params.putInt("count", u.size());

        WritableArray paramList = Arguments.createArray();
        for (int i = 0; i < u.size(); i++) {
          paramList.pushString(u.item(i).getUserid());
        }

        params.putArray("user_id_list", paramList);
        promise.resolve(params);
      }
    }
    else {
